...
var forms_1 = __webpack_require__(203);
var login_component_1 = __webpack_require__(193);
var newLogin_component_1 = __webpack_require__(194);
var login_form_component_1 = __webpack_require__(619);
var login_router_module_ts_1 = __webpack_require__(620);
...
LoginModule = __decorate([
    core_1.NgModule({
        imports: [
            login_router_module_ts_1.LoginRouterModule, forms_1.FormsModule, common_1.CommonModule
        ],
        declarations: [
            login_component_1.LoginComponent, newLogin_component_1.NewLoginComponent, login_form_component_1.LoginFormComponent
        ]
    })
], LoginModule);
...
exports.NewLoginComponent = NewLoginComponent;
...
var CouchService = (function () {
    function CouchService(http) {
        this.http = http;
        this.headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        this.baseUrl = 'http://127.0.0.1:5984/';
        this.handleRes = function (res) { return res.json(); };
    }
    CouchService.prototype.put = function (db, data) {
        var url = this.baseUrl + db;
        var putData = data ? JSON.stringify(data) : '';
        return this.http
    ...
    CouchService.prototype.post = function (db, data) {
        var url = this.baseUrl + db;
    ...
    CouchService.prototype.get = function (db) {
        var url = this.baseUrl + db;
        return this.http
            .get(url)
            .toPromise()
    ...
    CouchService.prototype.handleError = function (error) {
        return Promise.reject(error.json());
    };
    return CouchService;
}());
CouchService = __decorate([
    core_1.Injectable(),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_observable_forkJoin__ = __webpack_require__(162);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_observable_fromPromise__ = __webpack_require__(113);
...
exports.routes = [
    ...
    { path: 'login', loadChildren: function () { return new Promise(function (resolve) { new Promise(function(resolve) { resolve(); }).then((function (require) { resolve(__webpack_require__(123)['LoginModule']); }).bind(null, __webpack_require__)).catch(__webpack_require__.oe); }); } }
];
...
var app_router_module_ts_1 = __webpack_require__(616);
var couchdb_service_1 = __webpack_require__(195);
...
AppModule = __decorate([
    core_1.NgModule({
        imports: [
            platform_browser_1.BrowserModule, app_router_module_ts_1.AppRoutingModule, http_1.HttpModule
        ],
        declarations: [
            app_component_1.AppComponent
        ],
        providers: [couchdb_service_1.CouchService],
...
var LoginFormComponent = (function () {
    function LoginFormComponent(couchService) {
        this.couchService = couchService;
        this.createMode = false;
        this.model = { name: '', password: '', repeatPassword: '' };
        this.message = '';
    }
    ...
    LoginFormComponent.prototype.createUser = function () {
        var _this = this;
        ...
        if (this.model.password === this.model.repeatPassword) {
            this.couchService.put('_users/org.couchdb.user:' + this.model.name, { 'name': this.model.name, 'password': this.model.password, 'roles': [], 'type': 'user' })
                .then(function (data) { return _this.message = 'User created: ' + data.id.replace('org.couchdb.user:', ''); }, function (error) { return _this.message = ''; });
        }
        else {
    ...
    LoginFormComponent.prototype.login = function () {
        ...
        this.couchService.post('_session', { 'name': this.model.name, 'password': this.model.password })
            .then(function (data) {
            _this.message = 'Hi, ' + data.name + '!';
        }, function (error) { return _this.message = 'Username and/or password do not match'; });
    };
...
], LoginFormComponent.prototype, "createMode", void 0);
LoginFormComponent = __decorate([
    ...
    __metadata("design:paramtypes", [couchdb_service_1.CouchService])
], LoginFormComponent);
...
var routes = [
    ...
    { path: 'newuser', component: newLogin_component_1.NewLoginComponent }
];
